...
images.get('/images', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var width, height, fileName, output, existImage;
    return __generator(this, function (_a) {
        width = "".concat(req.query.width);
        ...
        if (existImage.length < 1) {
            try {
                (0, resize_1.default)(fileName, width, height, output)
            ...
            fs_1.promises.readFile(existImage).then(function (response) {
